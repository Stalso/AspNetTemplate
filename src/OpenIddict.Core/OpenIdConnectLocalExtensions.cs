...
{
    public static class OpenIdConnectLocalExtensions
    {
        /// <summary>
        ...
        public static Claim SetDestinations(this Claim claim, IEnumerable<string> destinations)
        {
            ...
            {
                claim.Properties.Remove(OpenIdConnectLocalConstants.Properties.Destinations);
            ...
            claim.Properties[OpenIdConnectLocalConstants.Properties.Destinations] =
