(function () {
    ...
    angular
        ...
        .factory('TemplateHub', ['$http', 'Hub', '$rootScope', 'Auth', '$q', '$timeout', function factory($http, Hub, $rootScope, Auth, $q, $timeout) {
            ...
            var hub = new Hub('msg', {
                ...
                securityTokenOptions: {
                    ...
                    tokenChangedEvent: function () {
                        ...
                        //this.stop();
                        //return $timeout(this.connect(), 1);
                        //return $q.when(setTimeout(function () {                            
                        //    this.connect();
                        //}, 1));
